...
export default {
  ...
  methods: {
    ...
    hasMajor(pitch) {
      return (
        !this.activeSteps[pitch] ||
        !this.activeSteps[(pitch + 4) % 12] ||
        !this.activeSteps[(pitch + 7) % 12]
      )
    },
    hasMinor(pitch) {
      return (
        !this.activeSteps[pitch] ||
        !this.activeSteps[(pitch + 3) % 12] ||
        !this.activeSteps[(pitch + 7) % 12]
      )
    },
  },
